                ...
                <div key={index}>
                    ...
                    {category.plants.map((plant, plantIndex) => (
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button style={{backgroundColor:alreadyInCart(plant.name)?"gray":"#11FF11"}} disabled={alreadyInCart(plant.name)? true:false} onClick={()=>handleAddToCart({name:plant.name,cost:plant.cost,image:plant.image})} className="product-button">Add to Cart</button>
                        </div>
                    ))}
                    </div>
                </div>
